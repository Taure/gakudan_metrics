...
Working agreement for agents and contributors on **gakudan_metrics** - a
Prometheus exporter and starter Grafana dashboard for gakudan.
...
**This repo** exports gakudan's telemetry events (gakudan ADR 0001) as
Prometheus metrics and ships a starter Grafana dashboard. Keep it in lockstep
with any gakudan release that changes the telemetry surface.
